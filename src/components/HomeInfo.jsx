...
const InfoBox = ({ text, link, btnText }) => (
    <div className='info-box'>
        <p className='font-medium sm:text-xl text-center text-base'>{text}</p>
        <Link to={link} className='neo-brutalism-white neo-btn text-base sm:text-xl'>
            {btnText}
...
const renderContent = {
    1: (
        <h1 className='sm:text-xl text-base sm:leading-snug text-center neo-brutalism-blue py-2 px-5 mx-5 text-white'>
